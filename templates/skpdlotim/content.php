	...
	<div class="container paddingnya">
		<div class="row">
			...
			<div class="container-fluid no-margin no-padding">
				<div class="hal-kecil-heading" style="padding:10px;">
					<!-- judul -->
					<h1 class="panel-title custom-font"><i class="fa fa-folder-open"></i> &nbsp;Data Harga Pasar</h1>
				</div>
				<div class="harga-pasar" style="padding:10px; background:#fff;">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="col-md-12 mb-5" style="padding:10px 0px;">
							<select class="form-control" id="komoditasAct">
								<?php 
								$pasar = mysql_query("SELECT * FROM pasar ORDER BY id_pasar DESC");
								while($p = mysql_fetch_array($pasar)){
					...
					<div class="table-responsive" style="max-height: 250px; overflow-y:scroll !important;" id="dkomoditas">
						<center><img src="https://www.catf.us/wp-content/themes/catf-5ive/assets/dist/img/progress.gif" width="15px" alt=""> Loading</center>
					</div>
					<script>
					</script>
				</div>
...
elseif($_GET['module']=='detailberita'){
	...
	if($d['gambar'] !== ""){
?>
	<meta property="og:image" content="foto_berita/<?= $d['gambar'] ?>"/>
<?php
	}
?>
						...
						<article class="content-box box-img bg-light box-clickable media">
							<div class="box-body media">
								...
								<div class="media-body">
									...
									<ul class="list-inline small">
										<li><span class="label label-warning"><i class="fa fa-calendar"></i> &nbsp; <?php echo tgl_indo($r['tanggal']);?></span></li>
