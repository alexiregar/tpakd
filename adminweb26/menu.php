...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
			...
			<li class="treeview <?php if($module=="harga_pasar" || $module=="komoditas" || $module=="pasar") echo "active"; ?>">
				<a href="#">
					<i class="fa fa-home"></i>
					<span><b>Komoditas Pasar</b></span>
					<i class="fa fa-angle-left pull-right"></i>
				</a>
				<ul class="treeview-menu">
					<li class="<?php if($module=="harga_pasar") echo "active"; ?>"><a href="?module=harga_pasar"><i class="fa fa-circle-o"></i> <span>Harga Pasar</span></a></li>
					<li class="<?php if($module=="pasar") echo "active"; ?>"><a href="?module=pasar"><i class="fa fa-circle-o"></i> <span>Pasar</span></a></li>
					<li class="<?php if($module=="komoditas") echo "active"; ?>"><a href="?module=komoditas"><i class="fa fa-circle-o"></i> <span>Komoditas</span></a></li>
				</ul>
			</li>
			<?php
			if($_SESSION['leveluser']=="admin"){
