...
--
-- Host: localhost:3306
-- Waktu pembuatan: 22 Des 2021 pada 20.37
...
(1, 'Beranda', './', 0, 'Y'),
(2, 'Selayang Pandang', '#', 0, 'Y'),
(3, 'Sambutan Kepala Dinas', 'statis-5-sambutan-kepala-dinas.html', 2, 'Y'),
(4, 'Visi dan Misi', 'statis-6-visi-dan-misi.html', 2, 'Y'),
(5, 'Profil', '#!', 0, 'Y'),
(6, 'Sejarah', 'statis-7-sejarah.html', 5, 'Y'),
(7, 'Motto/Semboyan', 'statis-8-mottosemboyan.html', 5, 'Y'),
(18, 'Pengajuan KUR', '#', 9, 'Y'),
(9, 'KUR Online', '#', 0, 'Y'),
(10, 'Informasi', '#', 0, 'Y'),
...
('admin', '18b17bbb2369935c6fc262c709822db6', 'Administrator', 'admin@padanglawasutarakab.go.id', '08238923848', 'admin', 'N', 'tcd4q3sv1ln3oc4tagfv276573'),
...
--
ALTER TABLE `halamanstatis`
  MODIFY `id_halaman` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
