...
// Apabila user sudah login dengan benar, maka terbentuklah session
  ...
  elseif ($_GET['module']=='komoditas'){
    if($_SESSION['leveluser']=="admin"){
      include "modul/mod_komoditas_pasar/komoditas.php";
    }
  }
  
  // Pasar
  elseif ($_GET['module']=='pasar'){
    if($_SESSION['leveluser']=="admin"){
      include "modul/mod_komoditas_pasar/pasar.php";
    }
  }

  // Harga Pasar
  elseif ($_GET['module']=='harga_pasar'){
    if($_SESSION['leveluser']=="admin"){
      include "modul/mod_komoditas_pasar/harga_pasar.php";
    }
  }
