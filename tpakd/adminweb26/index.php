...
<html>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo"><img src="paluta.png" width="30%"></img><br>Login<br /><b>Administrator </b>
      </div><!-- /.login-logo -->
	  ...
	  <p>&nbsp;</p>
	  <p class="text-center"><small>Copyright &copy; 2017 Kabupaten Padang Lawas Utara</a>. All rights reserved.</p>
    </div><!-- /.login-box -->
